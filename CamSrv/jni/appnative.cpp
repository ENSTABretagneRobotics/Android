...
extern "C" 
{
	int Java_com_example_camsrv_AppNativeService_AppNativeMain(JNIEnv* env, jobject thiz)
	{
	...
	int Java_com_example_camsrv_AppNativeService_AppNativeQuit(JNIEnv* env, jobject thiz)
	{
		// Unreferenced parameters.
		(void)env;
		(void)thiz;
